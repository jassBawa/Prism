...
export type MiniSymmetry = {
  ...
  instructions: [
    {
      ...
      discriminator: [47, 105, 155, 148, 15, 169, 202, 211];
      accounts: [
        {
          name: "creator";
          writable: true;
    ...
    {
      name: "setPaused";
      docs: ["Owner: pause / unpause a basket (halts deposit + rebalance)."];
    ...
    },
    {
      ...
      discriminator: [79, 67, 133, 132, 129, 164, 92, 201];
      accounts: [
        {
          name: "admin";
          writable: true;
  ...
  accounts: [
    {
      name: "basket";
      discriminator: [219, 79, 107, 135, 231, 243, 218, 248];
    },
    {
      name: "registry";
    ...
    {
      name: "supportedAsset";
      discriminator: [129, 27, 96, 192, 89, 180, 227, 200];
    },
  ];
  events: [
    {
      name: "basketCreated";
      discriminator: [26, 146, 108, 155, 189, 85, 8, 7];
    },
    {
      name: "deposited";
    ...
    {
      name: "rebalanced";
      discriminator: [74, 101, 57, 244, 181, 179, 52, 182];
    },
    {
      name: "supportedAssetSet";
      discriminator: [53, 98, 118, 75, 253, 110, 99, 229];
    },
    {
      name: "withdrawn";
