...
export const SUPPORTED_ASSETS: SupportedAsset[] = [
  ...
  },
  {
    key: "jup",
    symbol: "JUP",
    feedHex: "0a0408d619e9380abad35060f9192039ed5042fa6f82301d0e48bb52be830996",
    decimals: 6,
    quoteEligible: false,
  },
  {
    key: "bonk",
    symbol: "BONK",
    feedHex: "72b021217ca3fe68922a19aaf990109cb9d84e9ad004b4d2025ad6f529314419",
    decimals: 5,
    quoteEligible: false,
  },
  {
...
export const feedBytes = (feedHex: string): number[] =>
  Array.from(Buffer.from(feedHex, "hex"));
...
export const REBALANCE_THRESHOLD_BPS = 50; // 0.5% absolute drift (share of NAV)
export const REBALANCE_THRESHOLD_REL_BPS = 50; // 0.5% relative drift (vs. own target)
export const REBALANCE_SPREAD_BPS = 30; // 0.3% better-than-oracle edge paid to the arb
export const DEPOSIT_FEE_BPS = 50; // 0.5% of minted basket tokens to the creator
export const REBALANCE_INTERVAL_SECS = 5;

// On-chain bounds (match the program).
